...
def connect_to_db(app, db_uri=None):
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = db_uri or 'postgresql:///nutrition'
    app.config['SQLALCHEMY_DATABASE_URI'] = os.environment.get("DATABASE_URL", 'postgresql:///nutrition')
